...
Si no tienes git en tu equipo, puedes encontrar instrucciones para instalarlo aqui-> [este enlace]( https://docs.github.com/es/get-started/quickstart/set-up-git ).
